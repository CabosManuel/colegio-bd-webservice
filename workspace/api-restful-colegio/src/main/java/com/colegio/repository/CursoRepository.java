...
public interface CursoRepository extends CrudRepository<Curso, Integer> {
	...
	// todavía no empieza el año escolar por eso pongo 2020, para traer lo del año
	// pasado
	...
	@Query(value = "select c.nombre from cursos c where c.curso_id like ?", nativeQuery = true)
