...
CREATE TABLE IF NOT EXISTS `bd_mpb`.`justificion` (
  ...
  INDEX `fk_justificion_estudiante1_idx` (`id_estudiante` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_mpb`.`citaciones` (
  ...
  INDEX `fk_citaciones_estudiante1_idx` (`id_estudiante` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_mpb`.`permisos` (
  ...
  INDEX `fk_permisos_estudiante1_idx` (`id_estudiante` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_mpb`.`comunicado` (
  ...
  INDEX `fk_comunicado_estudiante1_idx` (`id_estudiante` ASC) VISIBLE,
